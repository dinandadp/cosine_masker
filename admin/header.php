...
<head>
  ...
  <title>Admin - Rekomendasi Masker Wajah Tradisional Berdasarkan Penelitian Ilmiah Menggunakan Cosine Similarity dan TF-IDF</title>
...
<body class="hold-transition skin-red sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      <a href="beranda.php" class="logo" style="background-color: #FCF6F8">
        <span class="logo-mini" style="background-color:#FCF6F8; color: #000000"><b>+</b></span>
    ...
    <aside class="main-sidebar" style="font-family: BrandonText-Light; font-size: 11px; background-color: #FCF6F8; letter-spacing:1.5px">
